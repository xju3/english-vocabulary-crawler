...
def create_video():
    ...
    button_upload = Config.Browser.find_element(By.XPATH, xpath_upload_video_button)
    button_upload.send_keys(path_mp4)
    # button_upload.click()


    # WebDriverWait(Config.Browser, 10, 0.1).until(lambda x: x.find_element(By.XPATH, xpath_tab_video).click())
    # WebDriverWait(Config.Browser, 20, 0.2).until(lambda x: x.find_element(By.XPATH, xpath_upload_video_button).send_keys(path_mp4))
    # WebDriverWait(Config.Browser, 10, 0.2).until(
    #     lambda x: x.find_element(By.XPATH, xpath_upload_video_button).send_keys(path_mp4))
    ...
    Config.Browser.find_element(By.XPATH, xpath_publish_button).click()
